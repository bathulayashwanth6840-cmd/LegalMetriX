...
import {
  ...
  FileWarning, Search, LogOut, Edit3
} from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 border-b border-slate-200/90 dark:border-slate-800 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[9px] text-blue-700 dark:text-blue-400 font-bold tracking-wider uppercase block">
                Enforcement Portal
              </span>
            </div>
          </div>
        ...
        {/* Demo Mode / Active Role Capsule Tag */}
        ...
        <nav
          ...
          className="flex-1 px-3 py-2 space-y-4 overflow-y-auto"
        >
          {navSections.map((section, sIdx) => (
            <div key={section.title}>
              {/* Optional Visual Divider between logical groups */}
              {section.hasDivider && sIdx > 0 && (
                <div
                  role="separator"
        ...
        {/* Legal Metrology Platform Indicator */}
      ...
      <nav
        ...
        className="sm:hidden fixed bottom-0 w-full bg-white dark:bg-[#0D1526] border-t border-slate-200 dark:border-slate-800 z-50 shadow-lg transition-colors"
      >
