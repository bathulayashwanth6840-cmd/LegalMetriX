          ...
          <div className="w-full lg:w-5/12 bg-slate-900 p-5 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-200">
            ...
            <div className="relative flex-1 flex items-center justify-center min-h-[260px] max-h-[360px] bg-slate-950 rounded-xl overflow-hidden">
              ...
              {(() => {
                ...
                const highlightedFusion = highlightedFieldKey ? scan?.extracted_fields?.fusion_fields?.[highlightedFieldKey] : null;
                const isHighlightOnThisSide = !highlightedFusion?.source_side || highlightedFusion.source_side.toLowerCase() === activeSide.toLowerCase();
              ...
              {(!sidesOcr[activeSide]?.bounding_polygons?.length && !scan?.bounding_boxes?.length) && (
